...
Starts a temporary local server, opens browser for Google authentication,
captures the authorization code, exchanges it for a permanent refresh_token,
    ...
    def do_GET(self):
        ...
        if "code" in params:
            ...
            <body style="font-family: sans-serif; text-align: center; padding: 50px;">
              ...
              <p>Google Search Console access granted. You may now close this browser window and return to Antigravity.</p>
            </body>
            </html>
            """
...
def save_refresh_token(refresh_token):
    ...
    # Mirror to ai-business-auditor/.env if exists
...
def main():
    ...
    print("=" * 60)
    print("Google Search Console OAuth Helper")
    print("=" * 60)
