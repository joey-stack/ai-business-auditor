...
- Target filepath: `outputs/clients/{slug}/audit_{YYYY-MM-DD}.md`
- Ensure the client folder `outputs/clients/{slug}/` exists prior to saving.

### Step 3: Render Local PDF via Pandoc (with Local Script Fallback)
1. Execute the rendering pipeline:
   - Primary: `pandoc outputs/clients/{slug}/audit_{date}.md -o outputs/clients/{slug}/audit_{date}.pdf`
...
```json
{
  "markdown_path": "outputs/clients/{slug}/audit_2026-09-15.md",
  "pdf_path": "outputs/clients/{slug}/audit_2026-09-15.pdf",
  "notion_url": null,
